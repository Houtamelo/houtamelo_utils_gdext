...
impl ConstGString {
    pub fn new(str: &'static str) -> Self {
        Self {
            gstring: GString::from(str),
            str,
        }
    }

    pub fn get(&self) -> GString { self.gstring.clone() }

    pub fn as_str(&self) -> &'static str { self.str }
}
...
impl ConstStringName {
    pub fn new(str: &'static str) -> Self {
        Self {
            string_name: StringName::from(str),
            str,
        }
    }

    pub fn get(&self) -> StringName { self.string_name.clone() }
